...
public class TextStorage : MonoBehaviour
{
    private string[] entries = new string[] {
        ...
        "Today our leader finally succumbed to the cold and lost his flame. We would have buried him with full honours on the Mountain – yet to our shame we did not even have enough heat among ourselves to make the journey. Till the end, he adamantly refused to consume the forest, staying true to the ancient agreement with the land to live on the offerings of the creatures. But those offerings have long ceased. O leader… I wish I had your level of conviction.",
        "When the Core in the Mountain broke, large amounts of mana surged rampantly through the Mountain. In rocky clefts and icy caves the mana collected, condensing into miniature mana crystals that animated the rocks and ice around them, creating the elementals. Initially, we considered them like us. However, we soon discovered they were not living beings, for they were incapable of any rationality. Mindlessly they would wander back and forth, attacking indiscriminately.",
